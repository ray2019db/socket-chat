class Usuarios {
    ...
    getPersona(id) { // obtiene la 1ra persona dentro del arreglo "this.personas" cuyo id coincida con el id pasado por parámetro. Devuelve un objeto con el "id" y el "nombre" de la persona "{ id: 'xxxxxxxxxxxx', nombre: 'xxxxxxxxxxxx' }"
        ...
        return persona; // Devuelve una persona en un objeto "{ id: 'xxxxxxxxxxxx', nombre: 'xxxxxxxxxxxx'}"
    };
    ...
    borrarPersona(id) { // Elimina una persoana del arreglo "this.personas" cuyo id coincida con el id pasado por parámetro
        ...
        return personaBorrada; // Retorna la persona eliminada en un objeto "{ id: 'xxxxxxxxxxxx', nombre: 'xxxxxxxxxxxx'}"
    };
};
